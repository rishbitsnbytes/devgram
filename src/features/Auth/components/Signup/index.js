...
const SignUp = () => {
  ...
  return (
    <section className="auth-container p-4 md:p-12 min-h-[90vh] w-full flex flex-col justify-center items-center my-8">
      <div className="signup-container max-w-[500px] w-full mx-auto h-full flex flex-col justify-center items-center gap-8 drop-shadow bg-pink-300/10 rounded-sm md:p-5 p-3">
        <h2 className="section-head auth-head text-pink-400 uppercase text-3xl md:text-4xl font-medium">
          Signup
        </h2>
        <form
        ...
        >
          <div className="form-group w-full">
            <label htmlFor="input-fname" className="auth-form-label">
              <span className="label-text relative w-max">First Name</span>
              <input
                type="text"
                id="input-fname"
                name="firstName"
          ...
          <div className="form-group w-full">
            <label htmlFor="input-lname" className="auth-form-label">
              <span className="label-text relative w-max">Last Name</span>
              <input
                type="text"
                id="input-lname"
                name="lastName"
          ...
          <div className="form-group w-full">
            <label htmlFor="input-username" className="auth-form-label">
              <span className="label-text relative w-max">Username</span>
              <input
                type="text"
                id="input-username"
                name="username"
          ...
          <div className="form-group w-full">
            <label htmlFor="input-password" className="auth-form-label">
              <span className="label-text relative w-max">Password</span>
          ...
          <div className="form-group w-full">
            <label htmlFor="input-confirm-password" className="auth-form-label">
