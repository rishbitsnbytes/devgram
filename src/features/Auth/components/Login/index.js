...
const Login = () => {
  ...
  return (
    <section className="auth-container p-4 md:p-12 min-h-full w-full flex flex-col justify-center items-center">
      <div className="login-container max-w-[500px] w-full mx-auto h-full flex flex-col justify-center items-center gap-8 drop-shadow bg-pink-300/10 rounded-sm md:p-5 p-3">
        ...
        >
          <div className="form-group w-full">
            ...
            >
              <div className="label-text relative w-max">Username</div>
              <input
                type="text"
                id="input-username"
                name="username"
          ...
          <div className="form-group w-full">
            ...
            >
              <div className="label-text relative w-max">Password</div>
          ...
          <div className="auth-button-containers w-full mt-6 flex flex-col items-center justify-center gap-5">
            <input type="submit" className="btn-primary-full" value="Login" />
            <input
              type="submit"
